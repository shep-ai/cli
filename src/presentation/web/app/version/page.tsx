    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight">{PACKAGE_NAME}</h1>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview">
            <Card>
              ...
              <CardContent className="space-y-1">
                ...
                <InfoRow label="Version" value={`v${VERSION}`} badge badgeVariant="default" />
          ...
          <TabsContent value="system">
            <Card>
              ...
              <CardContent className="space-y-1">
                <InfoRow label="Node.js" value="v22.x" badge badgeVariant="secondary" />
                <InfoRow label="React" value="v19.x" badge badgeVariant="secondary" />
                <InfoRow label="Next.js" value="v16.x" badge badgeVariant="secondary" />
