...
export function SettingsPageClient({ settings, shepHome, dbFileSize }: SettingsPageClientProps) {
  ...
  return (
    <div data-testid="settings-page-client" className="flex max-w-5xl gap-6">
      {/* ── Main content ── */}
      <div className="min-w-0 flex-1">
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            >
              Choose which AI coding agent powers your features. Each agent supports different
              models and capabilities. Authentication is resolved automatically via your active
              session.
            </SectionHint>
          </div>
          ...
          >
            ...
            >
              Control how autonomous each feature run is. Auto-approve skips the human review pause
              at each phase. Push and PR options control what happens after successful
              implementation.
            </SectionHint>
          </div>
          ...
          >
            ...
            >
              ...
              notifications, and native desktop alerts. Fine-tune which agent lifecycle events
          ...
          >
            ...
            <SectionHint>
              ...
              may change or be removed in future versions. Debug mode adds verbose logging useful
              for troubleshooting.
            </SectionHint>
          </div>
          ...
          >
            ...
            >
              All settings are stored in a local SQLite database at ~/.shep/data. The database uses
              a singleton record pattern with automatic migrations on startup.
            </SectionHint>
          </div>
        </div>
      </div>
      ...
      {/* ── Quick nav ── */}
      <nav className="hidden w-24 shrink-0 xl:block">
        <div className="sticky top-6 flex flex-col gap-0.5">
          <span className="text-muted-foreground mb-1 text-[9px] font-semibold tracking-widest uppercase">
            On this page
          </span>
          {SECTIONS.map((s) => (
            <a
