...
const ALLOWED_EXTENSIONS = new Set([
  ...
  'jsx', 'tsx', 'py', 'rb', 'go', 'rs', 'java', 'kt', 'c', 'cpp', 'h', 'hpp',
  'cs', 'swift', 'sh', 'bash', 'zsh', 'fish', 'ps1', 'bat', 'cmd', 'sql',
  'graphql', 'proto', 'toml', 'ini', 'cfg', 'conf', 'env', 'dockerfile',
  'makefile', 'cmake', 'gradle', 'sbt', 'lock', 'sum', 'mod',
