...
```bash
.cursor/skills/shep-kit:new-feature/scripts/init-feature.sh <NNN> <feature-name>
```
...
Templates are in: `.cursor/skills/shep-kit:new-feature/templates/`
...
See: `.cursor/skills/shep-kit:new-feature/examples/001-sample-feature/`
