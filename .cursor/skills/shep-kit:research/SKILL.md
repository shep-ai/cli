...
YAML template (source of truth): `.cursor/skills/shep-kit:new-feature/templates/research.yaml`

Markdown is auto-generated from YAML via `pnpm spec:generate-md`.

## Example

See: `.cursor/skills/shep-kit:research/examples/sample-research.md`
