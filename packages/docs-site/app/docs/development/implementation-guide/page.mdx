...
Incorrect: Working for hours, then updating tasks.md at the end

Correct: Update tasks.md after each item completion

### Mistake 2: Skipping CI Watch

Incorrect: Push and immediately start next phase

Correct: Push, watch CI, fix-loop if needed, only then proceed

### Mistake 3: Implementation Before Tests

Incorrect: Write entity, then write tests

Correct: Write tests FIRST (RED), then implement (GREEN)

### Mistake 4: Moving On with Red CI

Incorrect: "CI is flaky, I'll fix it later"

Correct: Fix immediately in a loop until green
