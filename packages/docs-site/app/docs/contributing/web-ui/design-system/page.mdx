...
Use Tailwind's standard spacing scale (custom spacing tokens are intentionally omitted to avoid conflicts with Tailwind v4):

```tsx
<div className="p-4 m-2 mt-6">      {/* Padding/Margin */}
<div className="flex gap-4">          {/* Gap */}
<div className="w-full h-64 max-w-md"> {/* Width/Height */}
```
