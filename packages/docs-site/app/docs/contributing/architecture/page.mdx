...
- [Clean Architecture](/docs/contributing/architecture/clean-architecture) -- Layer details and dependency rules
- [Repository Pattern](/docs/contributing/architecture/repository-pattern) -- Data access patterns
- [Agent System](/docs/contributing/architecture/agent-system) -- Agent implementation
- [Settings Service](/docs/contributing/architecture/settings-service) -- Settings architecture
...
- **Agent System**: LangGraph-based orchestration (see [Agent System](/docs/contributing/architecture/agent-system))
